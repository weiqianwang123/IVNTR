...
do
    ...
    if python3 predicators/main.py --env view_plan_hard --approach biplan \
        ...
        --neupi_load_pretrained "saved_approaches/final/view_plan_hard/biplan_$seed" \
        --approach_dir "saved_approaches/final/view_plan_hard/biplan_$seed" \
        --log_file logs/final/view_plan_hard/sim/biplan_ood_$seed.log; then
    ...
    if python3 predicators/main.py --env view_plan_hard --approach biplan \
        ...
        --neupi_load_pretrained "saved_approaches/final/view_plan_hard/biplan_$seed" \
        --approach_dir "saved_approaches/final/view_plan_hard/biplan_$seed" \
        --log_file logs/final/view_plan_hard/sim/biplan_in_domain_$seed.log; then
        echo "Seed $seed completed successfully."
    else
        echo "Seed $seed encountered an error."
    fi
