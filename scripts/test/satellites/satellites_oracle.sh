...
do
    ...
    if python3 predicators/main.py --env satellites --approach oracle \
        ...
        --log_file logs/satellites/ivntr_ood_test_oracle_$seed.log; then
    ...
    if python3 predicators/main.py --env satellites --approach oracle \
        ...
        --log_file logs/satellites/ivntr_indomain_oracle_$seed.log; then
        echo "Seed $seed completed successfully."
    else
        echo "Seed $seed encountered an error."
    fi
