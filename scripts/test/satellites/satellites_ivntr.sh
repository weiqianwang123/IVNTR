...
do
    ...
    if python3 predicators/main.py --env satellites --approach ivntr \
        ...
        --log_file logs/final/satellites/sim/satellites/ivntr_ood_$seed.log; then
    ...
    if python3 predicators/main.py --env satellites --approach ivntr \
        ...
        --in_domain_test True \
        --timeout 5 \
        --approach_dir "saved_approaches/final/satellites/ivntr_$seed" \
        --neupi_load_pretrained "saved_approaches/final/satellites/ivntr_$seed" \
        --log_file logs/final/satellites/sim/satellites/ivntr_indomain_$seed.log; then
        echo "Seed $seed completed successfully."
    else
        echo "Seed $seed encountered an error."
    fi
