...
do
    ...
    if python3 predicators/main.py --env satellites --approach random_nsrt \
        ...
        --load_data \
        --timeout 5 \
        --biplan_nsrt_path saved_approaches/final/satellites/biplan_${seed}/satellites__biplan__${seed}__ViewClear,IsCalibrated,HasChemX,HasChemY,Sees___aesuperv_False__.saved.neupi_info \
