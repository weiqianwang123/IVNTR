...
do
    ...
    if python3 predicators/main.py --env satellites --approach grammar_search_invention\
        ...
        --timeout 5 \
        --approach_dir "saved_approaches/demo/satellites/ivntr_grammar_$seed" \
        --neupi_save_path "saved_approaches/demo/satellites/ivntr_grammar_$seed" \
        --log_file /home/qianwei/IVNTR/logs/satellites/ivntr_ood_grammar_$seed.log; then
