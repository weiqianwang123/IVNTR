...
do
    ...
    if python3 predicators/main.py --env blocks_onclear --approach ivntr-pddl-loop \
        ...
        --approach_dir "saved_approaches/final/blocks_pos/ivntr_pddl_loop_$seed" \
        --neupi_save_path "saved_approaches/final/blocks_pos/ivntr_pddl_loop_$seed" \
        --log_file logs/blocks_pos/ivntr_ood_pddl_loop_$seed.log; then
