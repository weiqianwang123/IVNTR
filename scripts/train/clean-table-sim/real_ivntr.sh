...
REALWORLD_NUM_DEMOS=24 # Adjust based on how many demos you've converted
...
do
    ...
    if python3 predicators/main.py --env clean-table-real-real --approach ivntr \
        ...
        --neupi_pred_config "predicators/config/clean_table_real/pred_pdlm_skip_train.yaml" \
        ...
        --timeout 30 \
        --approach_dir "saved_approaches/demo/clean-table-real/ivntr_${DATA_SUFFIX}_$seed" \
        --neupi_save_path "saved_approaches/demo/clean-table-real/ivntr_${DATA_SUFFIX}_$seed" \
        --log_file logs/clean-table-real/ivntr_train_${DATA_SUFFIX}_$seed.log; then
