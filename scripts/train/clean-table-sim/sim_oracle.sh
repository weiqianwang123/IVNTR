...
DATA_SOURCE="sim"  # Change to "realworld" to use real-world demonstrations

# Number of real-world demonstrations to use (if DATA_SOURCE="realworld")
REALWORLD_NUM_DEMOS=7  # Adjust based on how many demos you've converted
...
do
    ...
    if [ "$DATA_SOURCE" = "realworld" ]; then
        ...
        EXPECTED_FILE="saved_datasets/clean-table-real__demo__oracle__${NUM_DEMOS}____${seed}__None.data"
        REALWORLD_FILE="saved_datasets/clean-table-real__demo__realworld__${NUM_DEMOS}____0__None.data"
    ...
    if python3 predicators/main.py --env clean-table-real --approach oracle \
        ...
        --timeout 30 \
        --approach_dir "saved_approaches/demo/clean-table-real/ivntr_oracle_${DATA_SUFFIX}_$seed" \
        --neupi_save_path "saved_approaches/demo/clean-table-real/ivntr_oracle_${DATA_SUFFIX}_$seed" \
        --log_file logs/clean-table-real/ivntr_train_oracle_${DATA_SUFFIX}_$seed.log; then
