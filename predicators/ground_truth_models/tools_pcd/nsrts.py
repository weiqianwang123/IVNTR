"""Ground-truth NSRTs for the tools-pcd environment."""
...
class ToolsPCDGroundTruthNSRTFactory(GroundTruthNSRTFactory):
    ...
    def get_nsrts(env_name: str, types: Dict[str, Type],
        ...
        ScrewMatch = predicates["ScrewMatch"]
        ScrewNotMatch = predicates["ScrewNotMatch"]
        # Options
        ...
        AdjustScrewdriverShape = options["AdjustScrewdriverShape"]
        ...
        def placeoncontraption_sampler(state: State, goal: Set[GroundAtom],
            ...
            pose_ux = pose_lx + ToolsPCDEnv.contraption_size
            pose_uy = pose_ly + ToolsPCDEnv.contraption_size
        ...
        preconditions = {
            ...
            LiftedAtom(ScrewNotMatch, [screw, screwdriver]),
            }
        add_effects = {
            LiftedAtom(ScrewMatch, [screw, screwdriver])}
        delete_effects = {LiftedAtom(ScrewNotMatch, [screw, screwdriver])}
        nsrts.add(
            NSRT("AdjustScrewdriverShape", parameters, preconditions,
